...
import stand_out_stickers from "./Sponsors/stand_out_stickers.png"
    ...
    return (
        <div id="sponsors" className="section" style={{ paddingTop: "12%" }}>
            ...
            <div className="image-container">
                ...
                <a href= "https://www.uoft.ai/"><img className="fade-in" style={{ width: "30%", height: "30%" }} src={uoft_ai} alt="Sponsor 4" /></a>
                ...
                <a href= "https://vectorinstitute.ai/"><img className="fade-in" style={{ width: "30%", height: "30%" }} src={vector_logo} alt="Sponsor 6" /></a>
                <a href= "https://www.solidworks.com/"><img className="fade-in" style={{ width: "30%", height: "50%", padding: "5%"}} src={solid_works} alt="Sponsor 7" /></a>
                <a href= "https://www.solidworks.com/"><img className="fade-in" style={{ width: "30%", height: "50%"}} src={stand_out_stickers} alt="Sponsor 8" /></a>
            </div>
        </div>
    );
} 
